...
export const Menu = ({ onSectionChange, menuOpened, setMenuOpened }) => {
  return (
    <>
      ...
      <div
        className={`z-10 fixed top-0 right-0 bottom-0 bg-background transition-all overflow-hidden flex flex-col
...
const MenuButton = (props) => {
  ...
  return (
    <button
      onClick={onClick}
      className="text-2xl font-bold cursor-pointer hover:text-primary transition-colors text-primary"
    >
      {label}
    </button>
  );
